// <copyright file="ParallelMatrixMultiplier.cs" company="AlexMagikov">
...
/// </summary>
public class ParallelMatrixMultiplier : MatrixMultiplierBase
{
    /// <summary>
    /// Parallel matrix multiplication.
    /// </summary>
    ...
    public override int[,] Multiply(int[,] matrix1, int[,] matrix2)
    {
        ...
        int rowsForThread = (rowsNum / threadsNum) + (rowsNum % threadsNum == 0 ? 0 : 1);
